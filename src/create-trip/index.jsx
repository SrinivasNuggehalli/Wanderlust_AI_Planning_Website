          ...
          <div>
            ...
            <div className='grid grid-cols-2 gap-5 mt-5'>
              {transportOptions.map((option, index) => (
                <div key={index} onClick={() => handleInputChange('transport', option.name)} className={`p-4 border cursor-pointer rounded-lg hover:shadow-lg transition-all ease-in-out duration-200 transform hover:-translate-y-1 ${formData?.transport === option.name && 'shadow-lg border-black'}`}>
